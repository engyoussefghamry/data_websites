...
var $header=$("#header"),$pageNav=$("#page_nav"),sticky=0;function fixedNav(){window.pageYOffset>sticky?$header.addClass("fixed"):$header.removeClass("fixed")}function fixedFabNav(){500<window.pageYOffset?$pageNav.addClass("show"):$pageNav.removeClass("show")}0<$("#header").length&&(sticky=header.offsetTop+100),window.onscroll=function(){fixedNav(),fixedFabNav()},$(document).ready(function(){$("#preloader").delay(1e3).fadeOut("fast"),$(".transition-page").addClass("page-fadeUp-transition-enter").delay(1e3).queue(function(){$(this).removeClass("page-fadeUp-transition-enter").addClass("page-fadeUp-transition-enter-active").dequeue().delay(1400).queue(function(){$(this).removeClass("page-fadeUp-transition-enter-active").addClass("page-fadeUp-transition-exit").dequeue()})}),$(".scrollnav").navScroll({scrollSpy:!0,activeParent:!0,activeClassName:"current"}),(new WOW).init(),$("#banner, #project, #subscribe").enllax(),$(".collapsible").collapsible(),$(".select").formSelect(),$(".tooltipped").tooltip();$.validate({form:"#contact_form",onSuccess:function(e){return M.toast({html:'<span>Message Sent</span><button onclick="M.Toast.dismissAll()" class="btn-icon waves-effect toast-action"><i class="material-icons">close</i></button>'}),!1}})}),function($){function numberRoller(e){var t=$(".roller-title-number-"+e).attr("data-min"),n=$(".roller-title-number-"+e).attr("data-max"),i=$(".roller-title-number-"+e).attr("data-delay");numberRoll(e,t,n,$(".roller-title-number-"+e).attr("data-increment"),1e3*i/(n-t))}function numberRoll(slno,min,max,increment,timeout){min<=max?($(".roller-title-number-"+slno).html(min),min=parseInt(min)+parseInt(increment),setTimeout(function(){numberRoll(eval(slno),eval(min),eval(max),eval(increment),eval(timeout))},timeout)):$(".roller-title-number-"+slno).html(max)}$(window).on("load",function(){$(document).scrollzipInit(),$(document).rollerInit()}),$(window).on("load scroll resize",function(){$(".numscroller").scrollzip({showFunction:function(){numberRoller($(this).attr("data-slno"))},wholeVisible:!1})}),$.fn.scrollzipInit=function(){$("body").prepend("<div style='position:fixed;top:0px;left:0px;width:0;height:0;' id='scrollzipPoint'></div>")},$.fn.rollerInit=function(){var e=0;$(".numscroller").each(function(){e++,$(this).attr("data-slno",e),$(this).addClass("roller-title-number-"+e)})},$.fn.scrollzip=function(e){var n=$.extend({showFunction:null,hideFunction:null,showShift:0,wholeVisible:!1,hideShift:0},e);return this.each(function(e,t){return $(this).addClass("scrollzip"),$.isFunction(n.showFunction)&&0<$("#scrollzipPoint").length&&!$(this).hasClass("isShown")&&$(window).outerHeight()+$("#scrollzipPoint").offset().top-n.showShift>$(this).offset().top+(n.wholeVisible?$(this).outerHeight():0)&&$("#scrollzipPoint").offset().top+(n.wholeVisible?$(this).outerHeight():0)<$(this).outerHeight()+$(this).offset().top-n.showShift&&($(this).addClass("isShown"),n.showFunction.call(this)),$.isFunction(n.hideFunction)&&$(this).hasClass("isShown")&&($(window).outerHeight()+$("#scrollzipPoint").offset().top-n.hideShift<$(this).offset().top+(n.wholeVisible?$(this).outerHeight():0)||$("#scrollzipPoint").offset().top+(n.wholeVisible?$(this).outerHeight():0)>$(this).outerHeight()+$(this).offset().top-n.hideShift)&&($(this).removeClass("isShown"),n.hideFunction.call(this)),this})}}(jQuery),$(function(){function o(e){}var t=!1;function a(e){e.data!=YT.PlayerState.PLAYING||t||(t=!0)}function e(){$("iframe#video_iframe").remove(),$("#video_modal .text-center").append("<div id='video_iframe'></div>")}$(".modal").modal({onOpenEnd:function(e,t){var n,i=t.getAttribute("data-video");n=i,new YT.Player("video_iframe",{height:"360",width:"640",videoId:n,playerVars:{autoplay:1,rel:0},events:{onReady:o,onStateChange:a}})},onCloseEnd:function(){e()}}),$(".modal .modal-close").click(function(){e()})}),$(function(){$("#featured_carousel").slick({dots:!0,infinite:!0,autoplay:!0,autoplaySpeed:5e3,speed:750,fade:!0,arrows:!1})});var darkMode="false";"undefined"!=typeof Storage&&(darkMode=localStorage.getItem("luxiDarkMode")||"false");var $header=$("#header"),$menu=$("#mobile_menu"),$slideMenu=$("#slide-menu");function initMap(){var e={lat:44.933076,lng:15.629058},t=document.getElementById("map"),n=new google.maps.InfoWindow({content:'<div id="content" class="buble"><h6 class="title pb-2 px-3">Head Quarter</h6><div class="row ma-3"><div class="col-sm-6 pa-0"><p><i class="material-icons">phone</i> +98 765 432 10</p></div><div class="col-sm-6 pa-0"><p><i class="material-icons">email</i> hello@luxi.com</p></div><div class="col-sm-12 pa-0"><p><i class="material-icons">location_on</i> Lorem ipsum street Block C - Vestibullum Building</p></div></div></div>'});if(t){var i,o=new google.maps.Map(t,{zoom:10,center:e});(i=new google.maps.Marker({position:e,map:o})).addListener("click",function(){n.open(o,i)})}}isOpen=!1,$(document).ready(function(){"true"===darkMode&&($("#app").removeClass("theme--light"),$("#app").addClass("theme--dark"),$("#theme_switcher").prop("checked",!0)),$("#theme_switcher").change(function(){$(this).is(":checked")?(localStorage.setItem("luxiDarkMode","true"),$("#app").removeClass("theme--light"),$("#app").addClass("theme--dark")):(localStorage.setItem("luxiDarkMode","false"),$("#app").removeClass("theme--dark"),$("#app").addClass("theme--light"))}),$(".dropdown-trigger").dropdown({closeOnClick:!1,alignment:"left"}),$("#mobile_menu").click(function(){isOpen=!isOpen,isOpen?$(".sidenav").sidenav("open"):$(".sidenav").sidenav("close")}),$(".sidenav").sidenav({onOpenStart:function(){isOpen=!0,$header.addClass("open-drawer"),$menu.addClass("is-active"),$slideMenu.addClass("menu-open")},onCloseEnd:function(){isOpen=!1,$header.removeClass("open-drawer"),$menu.removeClass("is-active"),$slideMenu.removeClass("menu-open")}})}),$(function(){$("#lang_menu li a").click(function(){var e=window.location.toString(),t=window.location.pathname.split("/"),n=t[t.length-2],i=t[t.length-1],o=$(this).data("lang");window.location=e.replace(n+"/"+i,o+"/"+i)}),$("#lang_select").on("change",function(){var e=$(this).val(),t=window.location.toString(),n=window.location.pathname.split("/"),i=n[n.length-2],o=n[n.length-1];return e&&(window.location=t.replace(i+"/"+o,e+"/"+o)),!1})});var mq={smUp:"screen and (min-wdth: 600px)",mdUp:"screen and (min-width: 960px)",lgUp:"screen and (min-width: 1280px)",xlUp:"screen and (min-width: 1920px)",xsDown:"screen and (max-width: 599px)",smDown:"screen and (max-width: 959px)",mdDown:"screen and (max-width: 1279px)",lgDown:"screen and (max-width: 1919px)"};function mqAddClass(e){$(e).each(function(){var e=$(this).data("class");$(this).addClass(e)})}function mqRemoveClass(e){$(e).each(function(){var e=$(this).data("class");$(this).removeClass(e)})}var handler_smUp={match:function(){mqAddClass(".mq-sm-up")},unmatch:function(){mqRemoveClass(".mq-sm-up")}},handler_mdUp={match:function(){mqAddClass(".mq-md-up")},unmatch:function(){mqRemoveClass(".mq-md-up")}},handler_lgUp={match:function(){mqAddClass(".mq-lg-up")},unmatch:function(){mqRemoveClass(".mq-lg-up")}},handler_xlUp={match:function(){mqAddClass(".mq-xl-up")},unmatch:function(){mqRemoveClass(".mq-xl-up")}},handler_xsDown={match:function(){mqAddClass(".mq-xs-down")},unmatch:function(){mqRemoveClass(".mq-xs-down")}},handler_smDown={match:function(){mqAddClass(".mq-sm-down")},unmatch:function(){mqRemoveClass(".mq-sm-down")}},handler_mdDown={match:function(){mqAddClass(".mq-md-down")},unmatch:function(){mqRemoveClass(".mq-md-down")}},handler_lgDown={match:function(){mqAddClass(".mq-lg-down")},unmatch:function(){mqRemoveClass(".mq-lg-down")}};enquire.register(mq.smUp,handler_smUp).register(mq.mdUp,handler_mdUp).register(mq.lgUp,handler_lgUp).register(mq.xlUp,handler_xlUp).register(mq.xsDown,handler_xsDown).register(mq.smDown,handler_smDown).register(mq.mdDown,handler_mdDown).register(mq.lgDown,handler_lgDown),$(function(){var e=$("#project_carousel");if(1279<window.innerWidth&&"rtl"===$("html").attr("dir")){var t=Math.floor(e.data("length")-2);setTimeout(function(){e.slick("slickGoTo",t)},100)}e.slick({dots:!1,infinite:!1,speed:500,autoplay:!1,slidesToShow:4,arrows:!1,variableWidth:!0,responsive:[{breakpoint:1100,settings:{slidesToShow:3,slidesToScroll:1}},{breakpoint:800,settings:{slidesToShow:2,slidesToScroll:1}},{breakpoint:600,settings:{slidesToShow:1,slidesToScroll:1}}]}),$("#prev_project").click(function(){e.slick("slickPrev")}),$("#next_project").click(function(){e.slick("slickNext")})}),$(function(){var e=$("#testi_img_carousel"),t=$("#testi_text_carousel");e.slick({dots:!1,infinite:!0,speed:500,autoplay:!0,autoplaySpeed:1e4,slidesToShow:1,fade:!0,arrows:!1,asNavFor:".slider-testi-text"}),t.slick({dots:!1,infinite:!0,speed:500,autoplay:!0,autoplaySpeed:1e4,slidesToShow:1,pauseOnHover:!1,arrows:!1,asNavFor:".slider-testi-image"}),$("#prev_testi").click(function(){t.slick("slickPrev")}),$("#next_testi").click(function(){t.slick("slickNext")})}),$(function(){var t=$("#youtube"),n=$("#banner_cover"),i=$("#btn_play"),o=$("#btn_play .play"),a=$("#btn_play .pause"),s=!0,l=window.matchMedia(mq.mdDown).matches;o.hide(),t.YTPlayer({videoId:"ZbrmXvbm8GA",width:1080,repeat:!0,playerVars:{autoplay:1,controls:0,rel:0,showinfo:0,mute:1,origin:"http://localhost:9002"},callback:function(){e()}});var e=function(){var e=t.data("ytPlayer").player;e.addEventListener("onStateChange",function(){l?e.pauseVideo():n.hide(),i.removeClass("hide")}),i.click(function(){(s=!s)?(e.playVideo(),o.hide(),a.show()):(e.pauseVideo(),o.show(),a.hide())})}});