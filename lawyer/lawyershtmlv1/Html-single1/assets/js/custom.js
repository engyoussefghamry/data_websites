...
function owlCarouselInit() {
    ...
    var owlExample5 = jQuery("#owl-example5");
    var owlExamplexs1 = jQuery("#owl-example-xs1");
    ...
    if (owlExample1.length) {
        owlExample1.owlCarousel({
            ...
            afterAction: function(el) {
                ...
                this.$owlItems.removeClass('next');
                this.$owlItems.removeClass('previous');
                //add class active
                this.$owlItems.eq(this.currentItem - 1).addClass('previous');
                this.$owlItems.eq(this.currentItem).addClass('active');
                this.$owlItems.eq(this.currentItem + 1).addClass('next');
            }
        });
    }
    ...
    if (owlExample5.length) {
        owlExample5.owlCarousel({
            items: 1,
	...
	if (owlExamplexs1.length) {
        owlExamplexs1.owlCarousel({
            items: 1,
            navigation: false, // Show next and prev buttons
            slideSpeed: 300,
            paginationSpeed: 400,
